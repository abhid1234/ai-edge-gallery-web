  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            <path d="M9 2v6H5l7 14 7-14h-4V2H9zm2 2h2v6h3l-4 8-4-8h3V4z" />
          </svg>
        ),
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            <path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm0 7V3.5L18.5 9H14zM7 13h10v2H7v-2zm0 4h7v2H7v-2zm0-8h5v2H7V9z" />
          </svg>
        ),
      },
      {
