  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] bg-[#F0F4F9]">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-4 px-4 pb-4 overflow-hidden min-h-0">
        {/* Garden grid card */}
        <div className="bg-white rounded-2xl shadow-sm flex-shrink-0 overflow-auto">
          <div className="px-4 pt-4 pb-1">
            <h3 className="text-sm font-semibold text-[#1F1F1F] flex items-center gap-1.5">
        ...
        <div className="flex-1 flex flex-col bg-white rounded-2xl shadow-sm overflow-hidden min-h-0">
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-2 min-h-0">
            <h3 className="text-sm font-semibold text-[#1F1F1F] flex items-center gap-1.5 mb-3">
          ...
          {/* Example commands */}
          <div className="px-4 py-2 border-t border-[#E9EEF6]">
            <p className="text-[10px] font-semibold text-[#747775] mb-1.5 uppercase tracking-wide">
              Try these commands
            </p>
          ...
          <form
            ...
            className="flex items-end gap-2 px-4 py-3 border-t border-[#E9EEF6]"
          >
            <textarea
              rows={1}
              value={input}
              ...
              className="flex-1 resize-none bg-[#FFFBF0] text-[#1F1F1F] placeholder-[#A0866E] text-sm px-4 py-2.5 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#CAA12A]/40 disabled:opacity-50 leading-relaxed overflow-hidden min-h-[40px]"
              style={{ height: "40px" }}
            />
